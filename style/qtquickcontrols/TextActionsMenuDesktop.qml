...
Controls.Menu {
    ...
    delegate: Kirigami.Settings.isMobile ? toolButtonDelegate : menuItemDelegate
    Component {
        id: menuItemDelegate
        Controls.MenuItem {
            __reserveSpaceForIndicator: root.__hasIndicators
            __reserveSpaceForIcon: root.__hasIcons
            __reserveSpaceForArrow: root.__hasArrows
        }
    }
    Component {
